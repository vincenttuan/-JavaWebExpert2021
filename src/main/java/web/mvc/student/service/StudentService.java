...
public class StudentService implements IService<Student> {
	...
	public int add(Student student) {
		if(isIdExists(student.getId())) {
			System.out.printf("StudentService.add() -> id: %d 已存在", student.getId());
			return 0; // 0:失敗
		}
	...
	public int update(Student newStudent) {
		...
		System.out.printf("StudentService.update() -> 無此學號: %d 的學生\n", newStudent.getId());
		return 0;
	}
	...
	public int deleteById(Integer id) {
		...
		System.out.printf("StudentService.deleteById() -> 無此學號: %d 的學生\n", id);
		return 0;
	}
